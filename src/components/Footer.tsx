...
export default function Footer() {
  ...
  return (
    <footer className="max-w-7xl mx-auto bg-black md:px-20 px-6 py-16">

      <div className="">
        <p className="text-xl font-medium tracking-tight text-zinc-200 ">Let&apos;s talk</p>
        <div className="my-8">
          <p className="text-zinc-400 mb-2">
            Github{" "}
            <Link target="_blank"
              className="text-zinc-300 hover:text-orange-300 duration-300"
        ...
        Interested in collaborating or discussing job opportunities? Reach out at 
        <Link className="hover:text-orange-300 duration-300 text-zinc-300"  href='#'
                onClick={(e) => {
        ...
        <div className="pt-3">
        <p className=" tracking-tight text-2xl text-zinc-200 gap-1 flex items-center">
          <span>
            <svg
              width="23"
              height="23"
          ...
          <p className="text-zinc-400">Crafted by Amartya Sinha.</p>
        </div>
      </div>
